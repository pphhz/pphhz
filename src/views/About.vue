<template>
    <div class="about">
        ...
        <h3>关于</h3>
        <pre>
    本网页是平和猴子因为个人兴趣制作的博客网页。
    后来，我发现还是本地写md更方便，而且怕泄密，就笔记很少更新。
    我有空会慢慢丰富其他生活娱乐方面的内容。

    在“主页-生活干货网站”里，我写了一些网址，个人觉得还是比较实用的，可以收藏（收藏本网页就够了嘿嘿嘿）
...
<style lang="scss" scoped>
    ...
    .about {
        ...
        min-width: 100%;
        overflow: hidden;
        background-image: url('../assets/images/waterColor/theSixSense1.jpg');
